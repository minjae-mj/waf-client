        ...
        <div className='left'>
          ...
          <div className='fridge_leftside'>
            ...
            <div className='left_items'>
              <img className='mandu' id='mandu-m' src={mandu}></img>
              <img className='eggs' id='eggs-m' src={eggs}></img>
              <img className='dairy' id='dairy-m' src={dairy}></img>
            </div>
          </div>
          ...
          <div className='fridge_rightside'>
            ...
            <div className='right_items'>
              <img className='seafood' id='seafood-m' src={fish}></img>
              <img className='meat' id='meat-m' src={meat}></img>
              <div className='freshSection'>
                <img className='fruits' id='fruits-m' src={fruit}></img>
                <img className='veges' id='veges-m' src={veges}></img>
              </div>
            </div>
          </div>
        </div>
